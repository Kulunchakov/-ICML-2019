...
param.accelerated=false;
param.decreasing=false;
[w logs_exp4a]=mex_svm_svrg(y,X,w0,param); % constant step size regime for init_epochs epochs
...
param.accelerated=false;
param.decreasing=false;
[w logs_exp5a]=mex_svm_svrg(y,X,w0,param); % constant step size regime for init_epochs epochs
param.decreasing=true;
param.epochs=nepochs-init_epochs;
...
save('gene100_dropout0.01.mat','logs_exp1','logs_exp2','logs_exp3','logs_exp4a','logs_exp4b','logs_exp5a','logs_exp5b','logs_exp6a','logs_exp6b');
...
param.epochs=nepochs-init_epochs;
[w logs_exp6b]=mex_svm_svrg(y,X,w,param);
save('gene100_dropout0.1.mat','logs_exp1','logs_exp2','logs_exp3','logs_exp4a','logs_exp4b','logs_exp5a','logs_exp5b','logs_exp6a','logs_exp6b');
...
param.epochs=nepochs-init_epochs;
[w logs_exp6b]=mex_svm_svrg(y,X,w,param);
save('gene100_dropout0.3.mat','logs_exp1','logs_exp2','logs_exp3','logs_exp4a','logs_exp4b','logs_exp5a','logs_exp5b','logs_exp6a','logs_exp6b');
