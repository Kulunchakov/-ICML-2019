...
template <typename T>
void cuda_add_exp(const int n, T* y, T* x, T b,cudaStream_t U = 0);
...
template <typename T>
void cuda_sqrt(const int n, T* y, cudaStream_t U = 0);

template <typename T>
void cuda_inv_thrs(const int n, T* x, T* y, const T thrs,cudaStream_t U = 0);
...
template <typename T>
void cuda_div(const int n, T* y, T* z);

template <typename T>
void cuda_set(const int n, T* y, const T nu);

template <typename T>
void cuda_sqr(const int n, T* y, cudaStream_t U = 0);

template <typename T>
void cuda_sqr(const int n, T* X, T* y, cudaStream_t U = 0);
...
template <typename T>
void cuda_custom6(const int n, T* x1, T* x2, T* x3);

template <typename T>
void cuda_custom7(const int n, T* x1, T* x2, T* x3);

template <typename T>
void cuda_mult(const int n, T* y, T* x);

template <typename T>
void cuda_mult(const int n, T* y, T* x, T* z);
